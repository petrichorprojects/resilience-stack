...
EYEBROW_LABEL = "CRISIS SKILL TECHNOLOGY STACK / LAUNCH CHECKLIST"
...
def cover_page(c):
    ...
    headline_lines = ["CRISIS SKILL", "TECHNOLOGY STACK", "LAUNCH CHECKLIST."]
    ...
    for label, fname in [
        ...
        ("Petrichor engagement ID", "cover_eng_id"),
    ]:
